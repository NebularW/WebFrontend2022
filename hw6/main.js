...
class Main {
    ...
    openModal(element) {
        ...
        this.snapButton.onclick = () => {
            ...
            element.src = hiddenCanvas.toDataURL('image/jpg');
    ...
    initializeStyleTransfer() {
        ...
        // this.setImage2(this.contentImg, 2);

        this.setImage2(this.contentImg, this.parser());
    ...
    parser() {
        let i = 0;
        for (i = 0; i < location.search.length; ++i) {
            // console.log(location.search.charAt(i));
            if (location.search.charAt(i) === '=') {
                break;
            }
        }
        ++i;
        let pic = 0;
        for (; i < location.search.length; ++i) {
            pic = pic * 10 + (location.search.charAt(i) - '0');
        }
        console.log(pic);
        return '' + pic;
    }
    ...
    setImage(element, selectedValue) {
        if (selectedValue === 'file') {
            ...
            element.src = 'assets/styles/' + selectedValue + '.jpg';
            console.log(element.src);
        }
    }

    setImage2(element, selectedValue) {
        if (selectedValue === 'file') {
            console.log('file selected');
            this.fileSelect.onchange = (evt) => {
                const f = evt.target.files[0];
            ...
            element.src = 'assets/pics/' + selectedValue + '.jpg';
        }
    }
